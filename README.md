...
- Bot detection bypass + session persistence via cookies/storage state
- Built with **Selenium** & **Playwright**
- Full **Tkinter GUI** with threaded scraping (no UI freeze)

---

### 🗂️ Python File Manager Pro *(11-Tool Suite)*
> A full-featured desktop file management app — CLI + Tkinter MEGA App

| Tool | Description |
|------|-------------|
| 🔍 File Search Engine | Search files by name, type, size |
| 📁 File Organizer | Auto-sort files by category |
| 🗑️ Junk Cleaner | Find & delete temp/junk files |
| ✏️ Bulk Renamer | Pattern-based batch rename |
| 💾 Disk Usage Analyzer | Visual disk space breakdown |
| 📊 CSV Merger | Combine multiple CSV files |
| 📦 Directory Backup | One-click folder backup |
| 📝 Note Manager | Lightweight text note storage |
| 🔒 File Vault | Encrypt & hide sensitive files |
| 🤐 Smart Backup & Zip | Auto zip with compression |
| 🧹 CSV Data Cleaner | Remove duplicates, fix formatting |

Built using **OOP BaseTab inheritance architecture** — all 11 tools share a clean base class.

---

### 🌐 9 API-Based GUI Applications
> Real-world apps with live API integration and polished Tkinter interfaces

| App | API Used |
|-----|----------|
| 📖 Dictionary App | Free Dictionary API |
| 🌍 IP Tracker | IP Geolocation API |
| 🐙 GitHub Analyzer | GitHub REST API |
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=muhammadtayyab-portfolio&show_icons=true&theme=tokyonight&hide_border=true" width="48%"/>
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=muhammadtayyab-portfolio&layout=compact&theme=tokyonight&hide_border=true" width="40%"/>
</p>
